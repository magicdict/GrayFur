    ...
    get StatusIcon(): Array<[string, string]> {
        ...
        this.Item.StatusList.forEach(element => {
            switch (element) {
                ...
                case characterStatus.生命衰减:
                    s.push([ResourceMgr.icon_hp, "red"]);
                    break;
                case characterStatus.速度衰减:
                    s.push([ResourceMgr.icon_speed, "red"]);
                    break;
                case characterStatus.防御衰减:
                    s.push([ResourceMgr.icon_defence, "red"]);
                    break;
                case characterStatus.魂力衰减:
                    s.push([ResourceMgr.icon_skill, "red"]);
                    break;
                case characterStatus.攻击衰减:
                    s.push([ResourceMgr.icon_attact, "red"]);
                    break;
